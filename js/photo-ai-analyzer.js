...
写真から以下を判定してください:
1. 写真区分: 黒板や看板が写っていれば施工状況写真、重機や作業員が写っていれば施工状況写真、安全施設が目立てば安全管理写真、材料のみなら使用材料写真、計測器が写っていれば品質管理写真、更地や完成形なら着手前・完成写真
2. 撮影箇所: 写真内の黒板・看板に「No.」「STA」「測点」などの記載があればその値を抽出
3. 施工段階: 更地→着手前、作業中→施工中、完成形→完成

{
  ...
  "measurement_point": "写真内の黒板等から読み取れた測点情報（例: No.10+5.0）。読み取れなければ空文字",
  "key_elements": ["写真に写っている主要な構造物・資材"],
  "quality_check_items": ["確認できる品質管理項目"],
  "description": "施工管理上の説明（100文字程度、電子小黒板に記載する想定）",
  "alert": "安全上の問題点・注意点（なければnull）"
}`;
